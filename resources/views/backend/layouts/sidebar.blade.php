    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Route::current()->getName() == 'post.index' ? 'active' : '' }}">
                    <a href="{{ Route('post.index') }}" class='sidebar-link'>
                        <i class="bi bi-cash"></i>
                        <span>Master Post</span>
                    </a>
                </li>
                <li class="sidebar-item {{ Route::current()->getName() == 'slider.index' ? 'active' : '' }}">
